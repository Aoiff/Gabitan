...
def correct_grammar(text):
    ...
    corrected_text = text
    for issue in grammar_issues["matches"]:
        if "replacements" in issue:
            corrected_text = corrected_text.replace(issue["context"][issue["offset"]:issue["offset"]+issue["length"]], issue["replacements"][0]["value"])
